...
from Pac_company_dagster.defs.asset.product import create_dim_date
...
@asset_check(asset=create_dim_date)
def qc_dim_date(context: OpExecutionContext, dim_date_path): 
    '''This function is a quality check of dim_product'''
    spark = SparkSession.builder.getOrCreate()
    context.log.info('Data quality checking for dim_date')
    df = spark.read.parquet(dim_date_path)
