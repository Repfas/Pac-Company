...
from Pac_company_dagster.defs.asset.product import create_dim_product_category
...
@asset_check(asset=create_dim_product_category)
def qc_dim_product_category(context: OpExecutionContext, dim_product_category_path): 
    '''This function is a quality check of dim_product'''
    spark = SparkSession.builder.getOrCreate()
    context.log.info('Data quality checking for dim_product_category')
    df = spark.read.parquet(dim_product_category_path)
