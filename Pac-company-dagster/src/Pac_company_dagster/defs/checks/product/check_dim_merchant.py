...
from Pac_company_dagster.defs.asset.product import create_dim_merchant
...
@asset_check(asset=create_dim_merchant)
def qc_dim_merchant(context: OpExecutionContext, dim_merchant_path): 
    '''This function is a quality check of dim_product'''
    spark = SparkSession.builder.getOrCreate()
    context.log.info('Data quality checking for dim_merchant')
    df = spark.read.parquet(dim_merchant_path)
