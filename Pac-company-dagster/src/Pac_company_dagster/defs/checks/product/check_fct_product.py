...
from Pac_company_dagster.defs.asset.product import create_fct_product_price
...
@asset_check(asset=create_fct_product_price)
def qc_fct_product_price(context: OpExecutionContext, fct_product_price_path): 
    '''This function is a quality check of fct_product_price'''
    spark = SparkSession.builder.getOrCreate()
    context.log.info('Data quality checking for fct_product_price')
    df = spark.read.parquet(fct_product_price_path)
