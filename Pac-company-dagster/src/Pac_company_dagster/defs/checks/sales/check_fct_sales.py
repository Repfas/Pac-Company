...
from Pac_company_dagster.defs.asset.sales import create_fct_sales_price
...
@asset_check(asset=create_fct_sales_price)
def qc_fct_sales_price(context: OpExecutionContext, fct_product_price_path): 
    '''This function is a quality check of fct_sales_price'''
    spark = SparkSession.builder.getOrCreate()
    context.log.info('Data quality checking for fct_sales_price')
    ...
    pk_column = "sales_transaction_id"
    pk_null_count = (
