...
from Pac_company_dagster.defs.asset.sales import extract_sales_raw
...
@asset_check(asset=extract_sales_raw)
def qc_raw_data_sales(context: OpExecutionContext, raw_data_path): 
    '''This function is a quality check of raw_data'''
    spark = SparkSession.builder.getOrCreate()
    context.log.info('Data quality checking for raw data')
