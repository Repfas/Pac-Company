...
from Pac_company_dagster.defs.asset.sales import create_dim_product_sales
...
@asset_check(asset=create_dim_product_sales)
def qc_dim_product_sales(context: OpExecutionContext, dim_product_sales_path): 
    '''This function is a quality check of dim_product'''
    spark = SparkSession.builder.getOrCreate()
    context.log.info('Data quality checking for dim_price for sales')
    df = spark.read.parquet(dim_product_sales_path)
