...
from Pac_company_dagster.defs.asset.sales import transform_sales
...
@asset_check(asset=transform_sales)
def qc_cleaned_data_sales(context: OpExecutionContext, clean_data_path): 
    '''This function is a quality check of cleaned_data_sales'''
